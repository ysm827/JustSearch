...
def test_sidebar_stylesheet_changes_are_cache_busted():
    ...
    assert 'src="/static/js/main.js?v=54"' in index_source
    ...
    assert "from './modules/ui.js?v=19'" in main_source
    assert "from './modules/chat.js?v=25'" in main_source
