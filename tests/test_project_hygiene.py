...
def test_sidebar_stylesheet_changes_are_cache_busted():
    ...
    assert 'src="/static/js/main.js?v=50"' in index_source
    ...
    assert "from './modules/ui.js?v=16'" in main_source
    assert "from './modules/chat.js?v=21'" in main_source
