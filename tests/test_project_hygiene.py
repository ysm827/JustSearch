...
def test_sidebar_stylesheet_changes_are_cache_busted():
    ...
    assert 'src="/static/js/main.js?v=49"' in index_source
    ...
    assert "from './modules/ui.js?v=15'" in main_source
    assert "from './modules/chat.js?v=20'" in main_source
