...
import { initUI, elements } from './modules/ui.js?v=11';
import { setupChatHandler, syncQuickSettingsFromState } from './modules/chat.js?v=15';
...
import { setupSettingsModal } from './modules/settings-modal.js?v=37';
